...
use app\lib\baiduAI\common\AipBase;
...
class AipNlp extends AipBase
{
     ...
     * @var string
     */
    private $spamUrl = 'https://aip.baidubce.com/rest/2.0/antispam/v2/spam';
    ...
    function __construct()
    {
         ...
         * @var string
         */
        $this->apiKey = '3UkfhG9Nay8lpjCU8B4hQjoG';

        /**
         * secretKey
         * @var string
         */
        $this->secretKey = '4BUv5I8TMMFHWChfyUal8jNN95rnMZEe';

    }

    /**
     * 文本审核v2接口
     * @param string content -待审核文本，UTF-8，不可为空，不超过20000字节
     * @return array
     */
    public function spam($content)
    {
        $this->appId = '11471899';
        $this->apiKey = 'kyUfUb38Wgr2Fic8BVjf41cp';
        $this->secretKey = 'damBetFzgbXKVDG9czvEtqgHj5TWEOSO';
        $data = [];
        header("content-type:text/html;charset=utf-8");
        $data['content'] = $content;
        $header = ['Content-Type' => 'application/x-www-form-urlencoded'];
        return $this->request($this->spamUrl, $data, $header);
    }
