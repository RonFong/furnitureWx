...
use think\Request;
use app\admin\model\ContainerFunction as ContainerFunctionModel;

class ContainerFunction extends Base
{
    public function __construct(Request $request = null)
    {
        parent::__construct($request);
        $this->currentModel = new ContainerFunctionModel();
    }
    ...
    public function getDataList()
    {
        ...
        foreach ($list as $k => $v) {
            $list[$k]['goods_num'] = (new \app\admin\model\Product())->where('function_ids', 'like', "%{$v['id']}%")->count();
        }
